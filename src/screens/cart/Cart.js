        ...
        <View style={styles.container}>
            ...
            <View style={styles.stepContainer}>
                ...
                <View style={styles.stepItem}>
                    ...
                    <View>
                        <AppText style={styles.inactiveText}> Schedule </AppText>
                    </View>
                </View>
                <View style={{alignItems: 'center', flexDirection: 'row'}}>
                    <View style={styles.line} />
            ...
            <View style={[styles.subcontainer, {marginTop: 20}]}>
                <View style={styles.row}>
                    ...
                    <AppText style={styles.text}> $499.00</AppText>
                </View>
                <View style={styles.row}>
                ...
                <View style={styles.row}>
                    <AppText style={styles.highlight}>Total Payable Amount</AppText>
                    <AppText style={styles.highlight}> $470.82 </AppText>
                </View>
            </View>
            </ScrollView>
            <View style={styles.bottomContainer}>
                <View style={styles.addContainer}>
                    <AppText style={styles.text}>Add an address to proceed</AppText>
                    <TouchableOpacity
                ...
                <View style={styles.continueContainer}>
                    ...
                    <TouchableOpacity 
                        onPress={()=> NavigationService.navigate('Schedule')}
                    >
